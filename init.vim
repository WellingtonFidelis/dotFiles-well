...
""" COC (Conquer of Completions) Configuration ---------------------------

let g:coc_global_extensions = [ 'coc-snippets', 'coc-explorer', 'coc-pairs', 'coc-json', 'coc-git', 'coc-html', 'coc-css', 'coc-eslint', 'coc-tslint', 'coc-pyls', 'coc-emmet', 'coc-highlight', 'coc-htmldjango', 'coc-sql', ]
